...
/**
 * @author chendb
 * @description: 重写MapperRegistry 便于记录当前Mapper类型
 * @date 2021-02-28 10:18:58
 */
public class FlagwindMapperRegistry extends MapperRegistry {
    ...
    public FlagwindMapperRegistry(Configuration config) {
        super(config);
        this.config = config;
    }
    ...
    public static void setCurrentMapper(Class<?> type) {
        currentMapper = type;
    }
